...
int run_sdl()
{
	...
	SDL_Window* window = SDL_CreateWindow("Turtle Simulations", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, 1280, 720, window_flags);
	if (window == nullptr)
	{
	...
	simstudio::UiApp::AfterImguiInit();
